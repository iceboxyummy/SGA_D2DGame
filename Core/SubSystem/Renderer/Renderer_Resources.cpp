...
{
    blend_states[BlendStateType::Disabled] = std::make_shared<D3D11_Blend_state>(graphics);
    blend_states[BlendStateType::Disabled]->Create(false);

    blend_states[BlendStateType::Alpha] = std::make_shared<D3D11_Blend_state>(graphics);
