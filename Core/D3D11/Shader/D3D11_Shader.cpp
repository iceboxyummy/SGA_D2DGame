    ...
    if (shader_blob != nullptr)
    {
        ...
        case ShaderScope_VS:
        {
            ...
            (
                ...
                nullptr,
                reinterpret_cast<ID3D11VertexShader**>(&shader_resrouce)
            );
            assert(SUCCEEDED(hr));
            break;
        }
        case ShaderScope_PS:
        {
            ...
            (
                ...
                shader_blob->GetBufferSize(),
                nullptr,
                reinterpret_cast<ID3D11PixelShader**>(&shader_resrouce)
            );
            assert(SUCCEEDED(hr));
            break;
        }
